...
SeanceWithMovie::SeanceWithMovie(const int seance_id, const int seance_movie_id, const int seance_cinema_room_id, const std::string& seance_date_time, const std::string& movie_title, const std::string& movie_genre, const std::string& movie_author)
    : seance_id{seance_id}, seance_movie_id{seance_movie_id}, seance_cinema_room_id{seance_cinema_room_id},
...
SeanceWithMovie::SeanceWithMovie(SeanceWithMovie& swm)
    : seance_id{swm.seance_id}, seance_movie_id{swm.seance_movie_id}, seance_cinema_room_id{swm.seance_cinema_room_id},
